        ...
        <section className="relative py-20 md:py-32 overflow-hidden">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center text-center space-y-8">
              <div className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-blue-50 text-blue-800 text-sm font-semibold border border-blue-200 ${styles.staggerReveal}`}>
                <Sparkles className="h-5 w-5 text-blue-600" />
                Usado por +50 indústrias e varejos no Brasil
              </div>

              {/* Nome da Marca em Destaque GIGANTE */}
              <div className={`${styles.staggerReveal} space-y-3`}>
                <div className="inline-block">
                  <h1 className={`text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-500 bg-clip-text text-transparent mb-3 ${styles.brandName}`}>
                    SupriFlow
                  </h1>
              ...
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight max-w-4xl">
                Reduza <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">20% dos Custos</span> de Compras em 60 Dias
              </h2>
